const verification = (link) => `<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
...
<body>
	<div class="container">
        ...
        <p>You can verify your email by clicking on this button</p>
		<a style="margin-left: 200px" href="${link}"><button>Verify</button></a>
